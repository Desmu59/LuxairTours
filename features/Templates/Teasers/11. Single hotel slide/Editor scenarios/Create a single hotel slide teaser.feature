Feature: Create a single hotel slide teaser
  As a sales manager / content editor 
  I want to advertise 1 highly important hotel offer with this teaser

  Scenario: Create a Single hotel slide teaser with default contents and links

    Given I have content editor right
    And I am on the teaser creation page for the teaser "Single hotel slide"
    When I enter "Single hotel slide Scenario 1" in the field with name "name[0][value]"
  ...
  #Save the teaser
    ...
    Then the page title is Name Single hotel slide Scenario 1 | Luxairtours
  ...
  Scenario Outline: Create a Single hotel slide teaser with default contents and overwritten links
  ...
  #Configure the offers
    ...
    And I enter "Hotel name" in the field with name "field_headline_1[0][value]"
  ...
  #Checks
    ...
    Examples:
      ...
      |Single hotel slide Scenario 2|http://www.luxair.lu|Billets pas chers Luxembourg pour Milan \| Genève \| Berlin \| Vienne \| Londres \| Madrid avec Luxair|
      |Single hotel slide Scenario 3|Last-Minute (13)    |Last-Munute \| Luxairtours                         |
      |Single hotel slide Scenario 4|Edu Test (12)       |Edu Test \| Luxairtours                            |
      |Single hotel slide Scenario 5|Majorque (4)        |Majorque \| Luxairtours                            |
      |Single hotel slide Scenario 6|Page d'accueil (1)  |Page d'accueil \| Luxairtours                      |